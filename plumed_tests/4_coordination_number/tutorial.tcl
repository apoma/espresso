...
puts  $plumed_input "# a end-to-end distance" 
puts  $plumed_input "d1: DISTANCE ATOMS=1,40" 
puts  $plumed_input "# a coordination number of the other particles" 
puts  $plumed_input "c1: COORDINATION GROUPA=1-40 GROUPB=41-80 R_0=3.0 NN=14 MM=16 " 
puts  $plumed_input "# a moving restraint using d1: note that the kappa is kept if not specified " 
puts  $plumed_input "MOVINGRESTRAINT ... "
puts  $plumed_input "  ARG=d1  "
puts  $plumed_input "  STEP0=0      AT0=2.0   KAPPA0=5.0 "
puts  $plumed_input "  STEP1=20000  AT1=40.0  "
puts  $plumed_input "... MOVINGRESTRAINT "
puts  $plumed_input "# another moving restraint after the steer "
puts  $plumed_input " MOVINGRESTRAINT ... "
puts  $plumed_input "  ARG=c1 LABEL=sc1  "
puts  $plumed_input "  STEP0=20000  AT0=0.0   KAPPA0=0.0 " 
puts  $plumed_input "  STEP1=40000  AT1=1200.0 KAPPA1=0.1 " 
puts  $plumed_input "... MOVINGRESTRAINT "
puts  $plumed_input "PRINT ARG=* STRIDE=50 FILE=COLVAR"
puts  $plumed_input "PRINT ARG=c1,sc1.* STRIDE=50 FILE=COLVAR_COOR"
close $plumed_input
#
